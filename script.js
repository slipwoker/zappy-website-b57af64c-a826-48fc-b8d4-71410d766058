    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (value !== '') {
                ...
                if (name.toLowerCase().includes('email') && !validateEmail(value)) {
                    showError(input, 'Please enter a valid email address');
                    return false;
                }
                
                if (name.toLowerCase().includes('phone') && !validatePhone(value)) {
                    showError(input, 'Please enter a valid phone number');
                    return false;
                }
            }
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    setTimeout(function() {
                        ...
                        successMsg.style.cssText = 'color: #38a169; font-weight: 600; margin-top: 1rem;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b57af64c-a826-48fc-b8d4-71410d766058',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b57af64c-a826-48fc-b8d4-71410d766058';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b57af64c-a826-48fc-b8d4-71410d766058';
